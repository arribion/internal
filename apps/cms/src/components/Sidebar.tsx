import { ExternalLink, LogOut, PanelRightClose, PanelRightOpen } from "lucide-react";
    ...
    <aside
      ...
      <div className="px-2 pb-2 bg-gray-900">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-red-400 hover:text-red-500 hover:bg-red/5 transition-all">
