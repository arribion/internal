          ...
          <div className="bg-[#12121a] border border-white/10 rounded-xl p-4">
            ...
            {thumbnail ? (
              <div className="relative group mb-3">
                {/* ✅ object-contain: full image visible, no side trimming */}
                <div className="w-full h-64 bg-black/40 rounded-lg flex items-center justify-center overflow-hidden">
                  <img
                    src={thumbnail}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#12181a] border border-white/10 rounded-xl p-4">
            ...
            <div className="bg-[#0a0e0f] rounded-lg overflow-hidden border border-white/5">
              {thumbnail ? (
                <div className="w-full h-40 bg-black/40 flex items-center justify-center overflow-hidden">
                  <img
                    src={thumbnail}
                    alt=""
                    className="max-w-full max-h-full object-contain"
                ...
                <div className="w-full h-40 bg-linear-to-br from-sky-500/10 to-sky-500/10 flex items-center justify-center">
