...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <aside
      ...
      <div className="px-2 py-2 bg-slate-950">
        <button
          onClick={() => void logout()}
          className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm bg-rose-500/30 text-text-muted transition-colors hover:bg-bg-muted hover:text-text">
